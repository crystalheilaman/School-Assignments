...
/*	// add ids to the <a> tags
	...
	//use attr method to set IDs instead of .each
    ...
    $("article h2").before("<a href='#top' id='link'>▲Back to top▲</a>");
	$("article a:first").remove();
	$("article p:last").after("<a href='#top'>▲Back to top▲</a>");
	$("aside a:last").after("<a href='#heading1'><br/>Back to top</a>");
	...
	//Change the location of the aside when ANY of the "Back to top" links are clicked.
